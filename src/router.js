...
router.route("/weather/:lat&:long").get((req, res) => {
...
router.route("/friends/accept/:id").put((req, res) => {
  // accepts friend request
  Friends.acceptRequest(req, res);
});
router.route("/friends/:id&:username").delete((req, res) => {
  // delete a certain friend
  Friends.deleteFriend(req, res);
});

router.route("/users/:id&:search").get((req, res) => {
  // get all users
...
router
  .route("/progress/completion/:id")
  .get((req, res) => {
    // gets all completion information
    Progress.getDailyCompletion(req, res);
    res.send({
      message: "here is how you have been completing your reminders"
    });
  })
  .post((req, res) => {
...
router.route("/avatar/:id").get((req, res) => {
